...
classname = "F5 Agility Self Guided Labs - Introduction to ASM/Advanced WAF Behavioral DoS"

# OPTIONAL: The URL to the GitHub Repository for this class
github_repo = "https://github.com/meverett1167/bados-sg-agility-2018"
...
project = u'Introduction to ASM/AWAF Behavioral DoS'
copyright = u'2018, Michael Everett'
...
htmlhelp_basename = 'IntroductiontoASMAWAFBehavioralDoSdoc'
...
latex_documents = [
    (master_doc, 'IntroductiontoASMAWAFBehavioralDoS.tex', u'Introduction to ASM/AWAF Behavioral DoS Documentation',
...
man_pages = [
    (master_doc, 'introductiontoasmawafbehavioraldos', u'Introduction to ASM/AWAF Behavioral DoS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'IntroductiontoASMAWAFBehavioralDoS', u'Introduction to ASM/AWAF Behavioral DoS Documentation',
     author, 'IntroductiontoASMAWAFBehavioralDoS', 'One line description of project.',
     'Miscellaneous'),
]
